// lib/screens/categories/category_management_page.dart
        ...
        body: BlocBuilder<CategoryCubit, CategoryState>(
          builder: (context, state) {
            ...
            if (state is CategoryLoaded) {
              ...
              final incomeCategories = state.categories.where((c) => c.type == 'income').toList();
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (incomeCategories.isNotEmpty) ...[
                      _buildSectionHeader('Income Categories', Icons.trending_up, Colors.green),
                      const SizedBox(height: 8),
                      Card(
                        child: Column(
                    ...
                    if (expenseCategories.isNotEmpty) ...[
                      _buildSectionHeader('Expense Categories', Icons.trending_down, Colors.red),
                      const SizedBox(height: 8),
                      Card(
                        child: Column(
